...
myForm.onsubmit = function(e){
    ...
    fetch('https://michaelmason.dev/trendy/submit_leaderboard', {method : 'POST', body : form})
...
function checkAnswer(element){
    ...
    fetch('https://michaelmason.dev/trendy/get_answer/' + current_question_id)
    .then(res => res.json())
    .then(data => {
...
function getQuestion(){
    fetch('https://michaelmason.dev/trendy/get_question')
    .then(res => res.json())
    .then(data => {
...
function getLeaderboard(){
    fetch('https://michaelmason.dev/trendy/get_leaderboard')
    .then(res => res.json())
    .then(data => {
